...
def main():
    with sync_playwright() as p:
        ...
        page.goto("https://www-booksinprint-com.ezproxy.hkpl.gov.hk/Search/Results?q={{(genre:[Health,%20Mind%20and%20Body]%20OR%20subgenre:[Health,%20Mind%20and%20Body])}}%20AND%20synd_profile_rec:[$ANY_VALUE$]")
        page.wait_for_load_state('domcontentloaded')
        print("Landed on health_mind_body")
        page.goto("https://www-booksinprint-com.ezproxy.hkpl.gov.hk/Search/Results?q=&qs=1&&op=4&ps=100")
        page.wait_for_load_state('domcontentloaded')
