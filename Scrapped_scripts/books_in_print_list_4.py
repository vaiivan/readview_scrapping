...
def main():    
    with sync_playwright() as p:
        ...
        time.sleep(random.random()*5 + 2)
        page.goto("https://www-booksinprint-com.ezproxy.hkpl.gov.hk/Search/Results?q={{(genre:[Classic]%20OR%20subgenre:[Classic])}}%20AND%20synd_profile_rec:[$ANY_VALUE$]")            
        page.wait_for_load_state('domcontentloaded')
        time.sleep(random.random()*5 + 2)
