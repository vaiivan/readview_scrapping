...
def main():
    with sync_playwright() as p:
        ...
        page.goto("https://www-booksinprint-com.ezproxy.hkpl.gov.hk/Search/Results?q={{(genre:[Young%20adult%20fiction]%20OR%20subgenre:[Young%20adult%20fiction])}}%20AND%20synd_profile_rec:[$ANY_VALUE$]")
        page.wait_for_load_state('domcontentloaded')
        print("Landed on young_adult_fiction")
        page.goto("https://www-booksinprint-com.ezproxy.hkpl.gov.hk/Search/Results?q=&qs=1&&op=4&ps=100")
        page.wait_for_load_state('domcontentloaded')
        ...
        for j in range(2,7):
            ...
            for k in range(len(titles)-1):
                try:
                    ...
                    try:
                        book['genre'] = "young_adult_fiction"
                    except Exception as e:
