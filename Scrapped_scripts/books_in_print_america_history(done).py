...
def main():
    with sync_playwright() as p:
        ...
        # fiction.click()
        page.goto("https://www-booksinprint-com.ezproxy.hkpl.gov.hk/Search/Results?q=topic:[American%20history]%20AND%20synd_profile_rec:[$ANY_VALUE$]")
        page.wait_for_load_state('domcontentloaded')
        print("Landed on American History Genre")
        page.goto("https://www-booksinprint-com.ezproxy.hkpl.gov.hk/Search/Results?q=&qs=1&&op=4&ps=100")
        page.wait_for_load_state('domcontentloaded')
