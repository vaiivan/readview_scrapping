...
def main():
    with sync_playwright() as p:
        ...
        card.type('23838007925312', delay=100)
        pw = page.locator("#password")
        pw.type('YouSha11NotPa$$', delay=100)
        ...
        # fiction.click()
        page.goto("https://www-booksinprint-com.ezproxy.hkpl.gov.hk/Search/Results?q={{(genre:[Autobiography]%20OR%20subgenre:[Autobiography])}}%20AND%20synd_profile_rec:[$ANY_VALUE$]")
        page.wait_for_load_state('domcontentloaded')
        print("Landed on Autobiography")
        page.goto("https://www-booksinprint-com.ezproxy.hkpl.gov.hk/Search/Results?q=&qs=1&&op=4&ps=100")
        page.wait_for_load_state('domcontentloaded')
